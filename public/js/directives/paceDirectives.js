...
app.directive('resultPaceRaceinfo', function() {
	var run = '<span ng-if="raceinfo.race.racetype.name !== \'Swim\' && raceinfo.race.racetype.name !== \'Cycling\'"><span class="hoverhand" ng-show="result.agegrade !== undefined  && result.agegrade !== null && result.agegrade>=90" tooltip-append-to-body="true" uib-tooltip-html=\'"<span>Age Grade: {{result.agegrade}}%</span><br><span>World Class</span>" | unsafe \'>{{result | resultToPace:raceinfo.race}} <i  class="ageworld fa fa-star"></i></span><span class="hoverhand" ng-show="result.agegrade !== undefined && result.agegrade !== null && result.agegrade>=80 && result.agegrade<90" tooltip-append-to-body="true" uib-tooltip-html=\'"<span>Age Grade: {{result.agegrade}}%</span><br><span>National Class</span>" | unsafe\'>{{result | resultToPace:raceinfo.race}} <i class="agenational fa fa-star"></i></span><span class="hoverhand" ng-show="result.agegrade !== undefined && result.agegrade !== null && result.agegrade>=70 && result.agegrade<80" tooltip-append-to-body="true" uib-tooltip-html=\'"<span>Age Grade: {{result.agegrade}}%</span><br><span>Regional Class</span>" | unsafe\'>{{result | resultToPace:raceinfo.race}} <i class="ageregional fa fa-star"></i></span><span class="hoverhand" ng-show="result.agegrade !== undefined && result.agegrade !== null && result.agegrade<70" tooltip-append-to-body="true" uib-tooltip-html=\'"<span>Age Grade: {{result.agegrade}}%</span>" | unsafe\'>{{result | resultToPace:raceinfo.race}}</span><span ng-show="result.agegrade === undefined || result.agegrade === null">{{result | resultToPace:raceinfo.race}} </span></span>';
