angular.module('mcrrcApp.results').controller('YearRecordsController', ['$scope', 'AuthService', 'ResultsService', 'RecordsGridService', function ($scope, AuthService, ResultsService, RecordsGridService) {
    ...
    var LS_DISTANCES = 'mcrrcApp.yearRecords.customDistances';
    var LS_SURFACE   = 'mcrrcApp.yearRecords.surfaceFilter';
    var LS_COLLAPSED = 'mcrrcApp.yearRecords.customFilterCollapsed';
    var LS_SEX       = 'mcrrcApp.yearRecords.sexFilter';
    var LS_VALUEMODE = 'mcrrcApp.yearRecords.valueMode';

    var GRID_OPTS = {
        getRowKey: function (race) {
            return new Date(race.racedate).getUTCFullYear();
        },
        requireDateOfBirth: false,
        rowSort: function (a, b) { return b - a; }   // descending
    };
